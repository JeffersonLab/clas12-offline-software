...
public class ParticleResolutionCentralIn implements IParticleResolution {
	...
	public double getSigmaMom(Particle part, double torus) {
		...
		double p = part.p();
		/*
		 * double sig1p=(1.0/torus)* (params.get("FoMT1S1")+params.get("FoMT1S2")*Math.toDegrees(part.theta())+
		 * params.get("FoMT1S3")*Math.toDegrees(part.theta())*Math.toDegrees(part.theta())); double sig2p=(1.0/torus)*
