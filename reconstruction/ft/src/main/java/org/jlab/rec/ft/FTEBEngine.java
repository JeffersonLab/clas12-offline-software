...
//		EvioSource  reader = new EvioSource();
		String input = "/Users/devita/Work/clas12/simulations/tests/clas12Tags/4a.2.1/electron.hipo";
//		String input = "/Users/devita/out_gemc_10.hipo";
        ...
        h6.setTitleX("x (cm)"); h6.setTitleY("y (cm)");
        H2F h7 = new H2F("N. Clusters",24, -180., 180.,24, -180., 180.);         
        h7.setTitleX("x (cm)"); h7.setTitleY("y (cm)");
        H2F h8 = new H2F("Cluster Energy",100, 0., 9.,100, -0.5, 0.5);         
        h8.setTitleX("E (GeV)"); h8.setTitleY("Energy Resolution(GeV)");
        H2F h9 = new H2F("Cluster Energy",100, 2.,5.,100, -0.5, 0.5);         
        h9.setTitleX("#theta"); h9.setTitleY("Energy Resolution(GeV)");
        H2F h10 = new H2F("Cluster Energy",100, -180., 180.,100, -0.5, 0.5);         
        h10.setTitleX("#phi"); h10.setTitleY("Energy Resolution(GeV)");
        ...
        canvas.cd(4); canvas.draw(h5);
        for(int i=0; i<h6.getDataBufferSize(); i++) {
            float meanE = h6.getDataBufferBin(i);
            float nE    = h7.getDataBufferBin(i);
            if(nE>0) h6.setDataBufferBin(i, meanE/nE);
        }
        canvas.cd(5); canvas.draw(h6);
        canvas.cd(6); canvas.draw(h8);
        canvas.cd(7); canvas.draw(h9);
        canvas.cd(8); canvas.draw(h10);
        frame.add(canvas);
