...
public class StraightTrackCrossListFinder {
	 ...
	 * @return a flag to indicate that there is a unique cross per region in a crosslist
	 */
	 ...
	 * @param yxinterc the intercept for the line equation x = slope*y + intercept
