...
public class StraightTrack extends Trajectory {
	...
	/**
	 * updates the crosses in the track position based on the track straight line fit parameters
	 * @param fit_yxslope
	 * @param fit_yzslope
	 * @param geo
	 */
	...
	/**
	 * updates the cross position based on the track straight line fit parameters
	 * @param cross
	 * @param fit_yxslope
	 * @param fit_yzslope
	 * @param geo
