...
//    }
    ...
    public int compareTo(Cell arg0) {
        ...
        return this.get_state() < arg0.get_state() ? 1 : this.get_state() == arg0.get_state() ? 0 : -1;
    }
...
//		String tmp = (this.nb.size()>0) ?  this.nb.get(0) + " " + this.nb.get(nb.size()-1) : "";
    ...
    public boolean equals(Cell c) {// equals cannot be set between objects without using object field
        return c.get_c1().get_Id() == this.get_c1().get_Id() && c.get_c2().get_Id() == this.get_c2().get_Id();
    }
