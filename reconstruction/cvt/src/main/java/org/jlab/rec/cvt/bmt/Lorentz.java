...
public class Lorentz {
    ...
    public static double GetLorentzAngle(double xe, double xb) {
        ...
        double Q21 = 0;
        double Q22 = 0;
        double e1 = org.jlab.rec.cvt.bmt.Constants.emin;
        double e2 = org.jlab.rec.cvt.bmt.Constants.emax;
        double b1 = 0;
        double b2 = org.jlab.rec.cvt.bmt.Constants.bmax;
        if (i11 >= 0) {
            Q11 = org.jlab.rec.cvt.bmt.Constants.ThetaL_grid[i11];
            e1 = org.jlab.rec.cvt.bmt.Constants.E_grid[i11];
            b1 = org.jlab.rec.cvt.bmt.Constants.B_grid[i11];
        }
        if (i12 >= 0) {
            Q12 = org.jlab.rec.cvt.bmt.Constants.ThetaL_grid[i12];
        }
        if (xb >= org.jlab.rec.cvt.bmt.Constants.bmin) {
            Q21 = org.jlab.rec.cvt.bmt.Constants.ThetaL_grid[i21];
        }
        if (xb < org.jlab.rec.cvt.bmt.Constants.bmin) {
            Q21 = 0;
        }
        if (i22 >= 0) {
            Q22 = org.jlab.rec.cvt.bmt.Constants.ThetaL_grid[i22];
            e2 = org.jlab.rec.cvt.bmt.Constants.E_grid[i22];
            b2 = org.jlab.rec.cvt.bmt.Constants.B_grid[i22];
        }
