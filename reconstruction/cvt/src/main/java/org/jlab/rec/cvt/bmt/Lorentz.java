	...
	public static double getLorentzAngle(double xe, double xb) {
            ...
            if (xe<org.jlab.rec.cvt.bmt.Constants.emin) {
              ...
              if (xe>=org.jlab.rec.cvt.bmt.Constants.emax) {
                xe=org.jlab.rec.cvt.bmt.Constants.emax;
                System.err.println("Warning: E out of grid... setting it to Emax");
              }
              if (xb>org.jlab.rec.cvt.bmt.Constants.bmax) {
                xb=org.jlab.rec.cvt.bmt.Constants.bmax;
                //System.err.println("Warning: B field out of grid... setting it to Bmax = "+org.jlab.rec.cvt.bmt.Constants.bmax);
              }
              ...
              double R1 = linInterp( xe, e1,e2,Q11,Q12);
              double R2 = linInterp( xe, e1,e2,Q21,Q22);
