...
/** 
 * Returns the parameters of a fit with a circle to hits in the the CLAS12
 * where the solenoid field bends the particle path into a helix.  
 * These hits are represented as 3-dimensional points, that map to to 2-D points 
 * in the XY plane in the detector's Global coordinate system.  
 *
 */
