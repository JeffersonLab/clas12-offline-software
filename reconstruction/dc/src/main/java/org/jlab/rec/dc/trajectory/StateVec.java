...
/**
 * A StateVec describes a cross measurement in the DC. It is characterized by a
 * point in the DC tilted coordinate system at each wire plane (i.e. constant z)
 * and by unit tangent vectors in the x and y directions in that coordinate
 * system. The state vector parameters are the plane index, (x, y, tanTheta_x,
 * tanTheta_y). [The tilted coordinate system is the sector coordinate system
 * rotated by 25 degrees so that the z axis perperdicular to the wire planes]
 *
 * @author ziegler
 *
 */
