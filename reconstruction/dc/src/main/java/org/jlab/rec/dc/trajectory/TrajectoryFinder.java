...
public class TrajectoryFinder {
    ...
    /**
     *
     * @return the value of the integral of the magnetic field over the path
     * traveled by the particle as estimated from the fits to the crosses.
     */
    int counter = 0;
    ...
    public double integralBdl() {
        ...
        while (z <= z3) {
            ...
            Point3D bf = new Point3D(result[0], result[1], result[2]);
    ...
    /**
     * The parametric form of the trajectory determined from fitting the tangent
     * values of the state vecs linearly, and constraining the quadratic
     * parameters of the function describing the position values of the state
     * vecs.
     *
