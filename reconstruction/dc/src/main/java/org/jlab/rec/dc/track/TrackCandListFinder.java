...
public class TrackCandListFinder {
    ...
    public double getHitBasedFitChi2ToCrosses(int sector, double x1, double y1, double z1, double x2, double y2, double z2, double x3, double y3, double z3, 
        double p, int q, double x, double y, double z, double tanThX, double tanThY, Swim dcSwim) {
    ...
    public List<Track> getTrackCands(CrossList crossList, DCGeant4Factory DcDetector, double TORSCALE, Swim dcSwim) {
        ...
        for(int i = 0; i<crossList.size(); i++) {
            ...
            Trajectory traj = trjFind.findTrajectory(crossesInTrk, DcDetector, dcSwim);
                if(traj == null) 
                    continue;
                    ...
                    if(cand.size()==3) { 
                        ...
                        if(iBdl != 0) {
                            ...
                            if(this.trking.equalsIgnoreCase("HitBased")) { 
                                ...
                                double HBc2 = getHitBasedFitChi2ToCrosses(cand.get(0).get_Sector(), x1,  y1,  z1,  x2,  y2,  z2,  x3,  y3,  z3, 
...
public void matchHits(List<StateVec> stateVecAtPlanesList, Track trk, DCGeant4Factory DcDetector, Swim dcSwim) {
    ...
    double PathToFirstMeas = dcSwim.SwimToPlaneTiltSecSys(trk.get(0).get_Sector(), stateVecAtPlanesList.get(0).getZ())[6];
