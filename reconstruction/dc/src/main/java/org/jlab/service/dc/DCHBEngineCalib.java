...
public class DCHBEngineCalib extends ReconstructionEngine {
    ...
    public void setRunConditionsParameters(DataEvent event) {
        ...
        if (FieldsConfig.equals(newConfig) == false) {
            ...
            System.out.println(" TORUS SCALE = "+TorScale);
        }
    ...
    public static void main(String[] args) throws FileNotFoundException, EvioException {
        ...
        String inputFile = "/Users/ziegler/Workdir/Files/Data/DecodedData/DC/clas12_000797_a00000.hipo";
        ...
        //Writer
        String outputFile = "/Users/ziegler/Workdir/Distribution/DCTestMiniStagger2.hipo";
