...
public class CCDBConstantsLoader {
    ...
    // public static final DatabaseConstantProvider dbprovider = new
    // DatabaseConstantProvider(10,"default");
    ...
    public static final synchronized void Load(int runNb) {
        ...
        double[][][][] LSBCONVFAC = new double[6][3][62][2];
        // Load the tables
        ...
        // load the TDC conversions
        dbprovider.loadTable("/calibration/ftof/tdc_conv");
        ...
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/time_walk/tw0_left"); i++) {

            int iSec = dbprovider.getInteger(
                    "/calibration/ftof/time_walk/sector", i);
            int iPan = dbprovider.getInteger(
                    "/calibration/ftof/time_walk/layer", i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/time_walk/component", i);
            double iTW0L = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw0_left", i);
            double iTW1L = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw1_left", i);
            double iTW2L = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw2_left", i);
            double iTW0R = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw0_right", i);
            double iTW1R = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw1_right", i);
            double iTW2R = dbprovider.getDouble(
                    "/calibration/ftof/time_walk/tw2_right", i);
        ...
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/effective_velocity/veff_left"); i++) {

            int iSec = dbprovider.getInteger(
                    "/calibration/ftof/effective_velocity/sector", i);
            int iPan = dbprovider.getInteger(
                    "/calibration/ftof/effective_velocity/layer", i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/effective_velocity/component", i);
            double iEffVelL = dbprovider.getDouble(
                    "/calibration/ftof/effective_velocity/veff_left", i);
            double iEffVelR = dbprovider.getDouble(
                    "/calibration/ftof/effective_velocity/veff_right", i);
            double iEffVelLU = dbprovider.getDouble(
                    "/calibration/ftof/effective_velocity/veff_left_err", i);
            double iEffVelRU = dbprovider.getDouble(
                    "/calibration/ftof/effective_velocity/veff_right_err", i);
        ...
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/attenuation/y_offset"); i++) {
            int iSec = dbprovider.getInteger(
                    "/calibration/ftof/attenuation/sector", i);
            int iPan = dbprovider.getInteger(
                    "/calibration/ftof/attenuation/layer", i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/attenuation/component", i);
            double yoff = dbprovider.getDouble(
                    "/calibration/ftof/attenuation/y_offset", i);
            double atlR = dbprovider.getDouble(
                    "/calibration/ftof/attenuation/attlen_right", i);
            double atlL = dbprovider.getDouble(
                    "/calibration/ftof/attenuation/attlen_left", i);
            double atlRU = dbprovider.getDouble(
                    "/calibration/ftof/attenuation/attlen_right_err", i);
            double atlLU = dbprovider.getDouble(
                    "/calibration/ftof/attenuation/attlen_left_err", i);
        ...
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/gain_balance/sector"); i++) {
            int iSec = dbprovider.getInteger("/calibration/ftof/status/sector",
                    i);
            int iPan = dbprovider.getInteger(
                    "/calibration/ftof/gain_balance/layer", i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/gain_balance/component", i);
            double mipL = dbprovider.getDouble(
                    "/calibration/ftof/gain_balance/mipa_left", i);
            double mipR = dbprovider.getDouble(
                    "/calibration/ftof/gain_balance/mipa_right", i);
            double mipLU = dbprovider.getDouble(
                    "/calibration/ftof/gain_balance/mipa_left_err", i);
            double mipRU = dbprovider.getDouble(
                    "/calibration/ftof/gain_balance/mipa_right_err", i);
        ...
        // Getting the status
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/status/sector"); i++) {
            int iSec = dbprovider.getInteger("/calibration/ftof/status/sector",
                    i);
            int iPan = dbprovider.getInteger("/calibration/ftof/status/layer",
                    i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/status/component", i);
            int statL = dbprovider.getInteger(
                    "/calibration/ftof/status/stat_left", i);
            int statR = dbprovider.getInteger(
                    "/calibration/ftof/status/stat_right", i);
        ...
        for (int i = 0; i < dbprovider
                .length("/calibration/ftof/tdc_conv/sector"); i++) {
            int iSec = dbprovider.getInteger("/calibration/ftof/tdc_conv/sector",
                    i);
            int iPan = dbprovider.getInteger("/calibration/ftof/tdc_conv/layer",
                    i);
            int iPad = dbprovider.getInteger(
                    "/calibration/ftof/tdc_conv/component", i);
            LSBCONVFAC[iSec - 1][iPan - 1][iPad - 1][0] = dbprovider.getDouble(
                    "/calibration/ftof/tdc_conv/left", i);
            LSBCONVFAC[iSec - 1][iPan - 1][iPad - 1][1] = dbprovider.getDouble(
                    "/calibration/ftof/tdc_conv/right", i);
        }
        ...
        CSTLOADED = true;
        System.out
                .println("SUCCESSFULLY LOADED FTOF CALIBRATION CONSTANTS....");
        setDB(dbprovider);
    }
    ...
    public static void main(String arg[]) {
        ...
        /*
		 * try { ConstantProvider cp =
		 * GeometryFactory.getConstants(DetectorType.FTOF); geometry = new
		 * FTOFGeant4Factory(); } catch (IOException e) {
		 * System.err.println("Error Loading Geometry..."); // TODO
		 * Auto-generated catch block e.printStackTrace(); }
         */
 /*
		 * for(int itrack=0; itrack<1000; itrack++){ Line3d line = new
		 * Line3d(new Vector3d(rnd.nextDouble() * 10000 - 5000, rnd.nextDouble()
		 * * 10000 - 5000, 3000), new Vector3d(rnd.nextDouble() * 10000 - 5000,
		 * rnd.nextDouble() * 10000 - 5000, 9000));
		 * 
		 * List<DetHit> hits = geometry.getIntersections(line);
		 * 
		 * for(DetHit hit: hits){ FTOFDetHit fhit = new FTOFDetHit(hit);
