...
public class FinalTrackInfo {
    ...
    public FinalTrackInfo(double px, double py, double pz, double vz, double theta, double phi, int numhits, double tl, double dEdx, double R, double A, double B, double chi2){
        _px = px;
        _py = py;
        _pz = pz;
        _vz = vz;
