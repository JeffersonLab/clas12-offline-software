...
public class AtomicShells {


    private static final int[] fNumberOfShells = {
            0,
...
// ----------------------------------------------------------
    ...
    private static final int[] fIndexOfShells = {
            0,
    ...
    private static final int[] fNumberOfElectrons = {
    ...
    private static final double[] fBindingEnergies = {
    ...
    public static int GetNumberOfShells(int Z) {
        return fNumberOfShells[Z];
    }

    public static int GetNumberOfElectrons(int Z, int ShellNb) {
        return fNumberOfElectrons[fIndexOfShells[Z] + ShellNb];
    }

    public static int GetNumberOfFreeElectrons(int Z, double th) {
        int idx = fIndexOfShells[Z];
        int idxmax = idx + fNumberOfShells[Z];
        int n = 0;
        for (int i = idx; i < idxmax; ++i) {
            if (fBindingEnergies[i] * SystemOfUnits.eV <= th) {
    ...
    public static double GetBindingEnergy(int Z, int ShellNb) {
        return fBindingEnergies[fIndexOfShells[Z] + ShellNb] * SystemOfUnits.eV;
    }
