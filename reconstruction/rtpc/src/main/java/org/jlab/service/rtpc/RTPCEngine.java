...
public class RTPCEngine extends ReconstructionEngine {
  ...
  public boolean processDataEvent(DataEvent event) {
    ...
    if (event.hasBank("RTPC::adc")) {
      ...
      try {
        ...
        new NewHitStrategy(params, reconTrackMap);
        new KalmanFitter(params, reconTrackMap, KFTrackMap, magfield);
  ...
  public static void main(String[] args) {
    ...
    System.setProperty(
        "CLAS12DIR", "/Users/davidpayette/Desktop/newrtpcbranch/clas12-offline-software");
