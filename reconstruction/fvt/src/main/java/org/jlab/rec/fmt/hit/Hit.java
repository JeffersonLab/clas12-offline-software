...
/**
 *
 * A  hit characterized by layer, sector, wire number, and Edep.  The ADC to time conversion has
 * been already done.
 * @author ziegler
 */
...
public class Hit implements Comparable<Hit>{
	...
	public int compareTo(Hit arg0) {
		if (this._Strip > arg0._Strip) return 1;
		else 						   return 0;
	}
	...
	public String printInfo() {
		String s = " Hit: ID " + this.get_Id()    + " Sector " + this.get_Sector()
