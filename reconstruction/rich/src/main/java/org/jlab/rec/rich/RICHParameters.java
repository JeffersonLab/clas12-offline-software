...
public class RICHParameters{
    ...
    public double  RICH_DIRECT_RMS                        =   6.0;      // Expected single photon angular resolution (mrad)
    ...
    public double  RAYTRACE_PRECISION                     =   0.1;      // Fraction of RICH equivalent resolution
    ...
    public double  PIXEL_NOMINAL_BACKGR                   =   5.e-7;    // nominal pixel background
    public double  RICH_NOMINAL_NELE                      =   16;       // nominal photon yield for electron
    public double  RICH_BKG_LPROBABILITY                  =   1.e-5;    // Background probability for likelihood
    ...
    //------------------------------
    public void init_FlagCCDB(IndexedTable flagConstants) {
    //------------------------------
	...
	PROCESS_RAWDATA             =  flagConstants.getIntValue("reco_raw", 0, 0, 0);
        ...
        DO_MIRROR_HADS              =  flagConstants.getIntValue("do_spher", 0, 0, 0);
    ...
    //------------------------------
        ...
        RICH_HITMATCH_RMS           =  paraConstants.getDoubleValue("hit_match", 0, 0, 0);

        RICH_DIRECT_RMS             =  paraConstants.getDoubleValue("direct_rms", 0, 0, 0) / 1000.;
        ...
        RAYTRACE_PRECISION          =  paraConstants.getDoubleValue("ray_reso", 0, 0, 0);
        ...
        PIXEL_NOMINAL_BACKGR        =  paraConstants.getDoubleValue("ref_back", 0, 0, 0);
        RICH_NOMINAL_NELE           =  paraConstants.getDoubleValue("ref_Nele", 0, 0, 0);
        RICH_BKG_LPROBABILITY       =  paraConstants.getDoubleValue("back_prob", 0, 0, 0);

        SHOW_PROGRESS_INTERVAL      =  paraConstants.getDoubleValue("progess_delta", 0, 0, 0);

    }


    //------------------------------
    //public void old_ParametersCCDB(IndexedTable paraConstants) {
    //------------------------------
      ...
      //  int debugMode = 0;
       ...
       /* DO_ANALYTIC                 =  paraConstants.getIntValue("flag6", 4, 0, 0);
        ...
        PIXEL_NOMINAL_STIME         =  paraConstants.getDoubleValue("par8", 4, 0, 0);
        ...
        */
        ...
        DO_LHCB_LIKE                  =  0;
        USE_SIGNAL_BANK               =  0;
        USE_ELECTRON_ANGLES           =  1;
        */
        //PIXEL_NOMINAL_BACKGR          =  1.e-5; // for pass1 comparison
        //USE_LIKE_DELTAN               =  1;
    ...
    //------------------------------
        ...
        System.out.format("CCDB RICH PARA    RICH_DIRECT_RMS              %9.3f (mrad) \n", RICH_DIRECT_RMS*1e3);
        ...
        System.out.format("CCDB RICH PARA    RAYTRACE_PRECISION           %9.3f (e-2) \n", RAYTRACE_PRECISION*1e2);
        System.out.format("CCDB RICH PARA    RAYTRACE_MAX_NSTEPS          %9d \n", RAYTRACE_MAX_NSTEPS);

        System.out.format("CCDB RICH PARA    PIXEL_NOMINAL_STIME          %9.3f (ns) \n", PIXEL_NOMINAL_STIME);
        System.out.format("CCDB RICH PARA    PIXEL_NOMINAL_BACKGR         %9.3f (e-7) \n", PIXEL_NOMINAL_BACKGR*1e7);
        System.out.format("CCDB RICH PARA    RICH_NOMINAL_NELE            %9.3f \n", RICH_NOMINAL_NELE);
        System.out.format("CCDB RICH PARA    RICH_BKG_LPROBABILITY        %9.3f (e-5) \n", RICH_BKG_LPROBABILITY*1e5);

        System.out.format("CCDB RICH PARA    SHOW_PROGRESS_INTERVAL       %9.3f (sec) \n", SHOW_PROGRESS_INTERVAL);
