...
public class PluginArc extends PluginShape {
	 ...
	 *            coordinates
	 * @param radius
	 *            the radius in world coordinates. Note: the arc will only
	 *            look circular if the plugin's world system has a 1:1 aspect
	 *            ratio.
	 * @param startAngle start angle in degrees measured
	 * @param openingAngle
	 * @param properties
	 *            extra custom properties
	 */
	public PluginArc(Plugin plugin, String info, double xc, double yc,
			double radius, double startAngle, double openingAngle, Object... properties) {
