...
import static com.nr.root.Roots.zbrent;
...
public class Test_zbrent {
  ...
  public void test() {
    ...
    System.out.printf("zbrent: Maximum discrepancy = %f\n", maxel(vecsub(root,yy)));
    localflag = maxel(vecsub(root,yy)) > xacc;
    globalflag = globalflag || localflag;
    if (localflag) {
      fail("*** zbrent: Incorrect roots");
  ...
  class Func_zbrent implements UniVarRealValueFun {
    Bessjy b = new Bessjy();
