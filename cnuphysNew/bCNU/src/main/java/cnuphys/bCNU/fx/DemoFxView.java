...
public class DemoFxView extends FxView {
	
    private Model model;
    private View view;


	public DemoFxView(String title, int x, int y, int w, int h) {
		super(title, x, y, w, h);
	}
	...
	public void start(JFXPanel panel) {
    	...
    	view = new View(model);
    	hookupEvents();
        System.err.println("Setting the scene");
        panel.setScene(view.scene);
	}
