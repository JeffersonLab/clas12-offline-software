...
public class Swimmer {
    ...
    public static synchronized void setMagneticFieldsScales(double SolenoidScale, double TorusScale, double shift) {
        ...
        FieldsLoaded = true;
        LOGGER.log(Level.INFO," TRACKING ***** ****** ****** THE TORUS IS BEING SCALED BY " + (TorusScale * 100) + "  %   *******  ****** **** ");
        LOGGER.log(Level.INFO," TRACKING ***** ****** ****** THE SOLENOID IS BEING SCALED BY " + (SolenoidScale * 100) + "  %   *******  ****** **** ");
    }
