...
public class FastMath {
	...
	public static double atan2(double y, double x) {
		...
		case FAST:
			return org.apache.commons.math3.util.FastMath.atan2(y, x);
		case SUPERFAST:
<<<<<<< HEAD:common-tools/cnuphys/magfield/src/main/java/cnuphys/magfield/FastMath.java
			return Icecore.atan2((float) y, (float) x);
=======
			return Icecore2.atan2((float)y, (float)x);
>>>>>>> development:common-tools/clas-math/src/main/java/org/jlab/clas/clas/math/FastMath.java
		default:
			return Math.atan2(y, x);
		}
