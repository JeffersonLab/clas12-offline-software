...
public class StreamManager {
	...
	/**
	 * Remove a IStreamProcessor. IStreamProcessor listeners listen for new physics
	 * events.
	 * 
	 * @param listener the IStreamProcessor listener to remove.
	 */
	...
	/**
	 * Add a IStreamProcessor. IStreamProcessor listeners listen for new events.
	 * 
	 * @param listener the IStreamProcessor listener to add.
