...
public abstract class PhysicsEventConsumer implements IPhysicsEventListener, IStreamProcessor {
	...
	/**
	 * The null constructor is the one called during discovery. So don't overload
	 * with a non-null constructor
	 */
	...
	/**
	 * If the consumer flags an event, it will be asked to return the reason.
	 * 
	...
	/**
	 * Checks whether this consumer is active. Only active consumers get new
	 * streaming events.
	 * 
	...
	/**
	 * Sets whether this consumer is active. Only active consumers get new streaming
	 * events.
	 * 
