...
public class ConsumerManager extends Vector<PhysicsEventConsumer>
		implements IPhysicsEventListener, IStreamProcessor, ActionListener {
	...
	// private Hashtable<PhysicsEventConsumer, JCheckBoxMenuItem> hash = new
	// Hashtable<>();
...
//		add(resConsumer);
		...
		try {
			_consumerClaz = (Class<PhysicsEventConsumer>) Class
					.forName("cnuphys.fastMCed.consumers.PhysicsEventConsumer");
