...
public abstract class AEventGenerator {
	...
	/**
	 * Get the event count; i.e. the total number of events that can be accessed. If
	 * this is unknown (essentially infinite) return Integer.MAX_VALUE.
	 * 
	...
	/**
	 * This generator is being closed (discarded) in place of a new generator. If
	 * the generator needs to clean up, free up resources, etc. it should override
	 * this method. Otherwise it can just keep this empty implementation.
	 */
	public void close() {
	...
	/**
	 * Get the number of events available for streaming. If this is an infinite
	 * source then this will return Integer.MAX_VALUE.
	 * 
