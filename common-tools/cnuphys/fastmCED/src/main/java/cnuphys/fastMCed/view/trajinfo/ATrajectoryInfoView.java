...
public abstract class ATrajectoryInfoView extends BaseView implements IPhysicsEventListener {
	...
	protected ATrajectoryInfoView(String title) {
		super(PropertySupport.TITLE, title, PropertySupport.ICONIFIABLE, true, PropertySupport.TOOLBAR, false,
				...
				PropertySupport.WIDTH, 1050, PropertySupport.HEIGHT, 350, PropertySupport.LEFT, 700,
