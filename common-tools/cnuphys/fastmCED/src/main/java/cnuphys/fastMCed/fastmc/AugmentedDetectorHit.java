...
/**
 * Augmented hits wrap an underlying FastMC Detector hit so that additional
 * information cane be attached.
 * 
 * @author heddle
 *
 */
public class AugmentedDetectorHit {
	 ...
	 * 
	 * @return <code>true</code> if this is a DC noise hit as determined by the
	 *         cnuphys SNR package. Return <code>false</code> it it wasn't, or if
	 *         this hit is to a Drift Chamber hit.
	 */
