...
public interface ISuperLayer {
	...
	/**
	 * Get the projection plane. For SectorView this is the constant phi plane and
	 * is the same for all superlayers. For ProjectedDCView it is the
	 * 
	...
	/**
	 * Check whether this is in a "lower" sector 4,5,6. Only relevant for
	 * SectorView. For superlayers on the DCProjectedView, should return false;
	 * 
	 * @return for SectorViews return <code>true</code> for sectors 4,5,6. Otherwise
	 *         false.
	 */
