...
/**
 * Holds hits separated by sector and superLayer. So the final lists will have a
 * mix of layer and component Ids
 * 
 * @author heddle
 *
 */
public class HitHolder {
	...
	/**
	 * Get the hit count of hits with the matching sector and superLayer. They will
	 * be a mix of layers and components
	 * 
	 * @param sect0 zero based sector
	 * @param supl0 zero based superLayer
	...
	private boolean inRange(int sect0, int supl0) {
		return (((sect0 >= 0) && (sect0 < _numSector)) && ((supl0 >= 0) && (supl0 < _numSuperLayer)));
	}
