...
public class SuperLayerDrawing {
	...
	private void drawSNRMasks(Graphics g, IContainer container) {
		...
		NoiseReductionParameters parameters = SNRManager.getInstance().getParameters(_iSupl.sector() - 1,
				_iSupl.superlayer() - 1);
	 ...
	 * @param doca      the distance of closest approach array in mm
	 * @param sdoca     the smeared distance of closest approach array in mm
	 */
