...
public abstract class ASwimTest {
	...
	/**
	 * A list of single runs. If more than one they will be timed against each other
	...
	/**
	 * Add a single run. All single runs will be timed for the same number of
	 * iterations.
	 * 
	...
	protected double[] nextRandom3Vect(double minVal1, double maxVal1, double minVal2, double maxVal2, double minVal3,
			double maxVal3) {
	...
	protected void nextRandom3Vect(double minVal1, double maxVal1, double minVal2, double maxVal2, double minVal3,
			double maxVal3, double val[]) {
	...
	protected float[] nextRandom3Vect(float minVal1, float maxVal1, float minVal2, float maxVal2, float minVal3,
			float maxVal3) {
	...
	protected void nextRandom3Vect(float minVal1, float maxVal1, float minVal2, float maxVal2, float minVal3,
			float maxVal3, float val[]) {
