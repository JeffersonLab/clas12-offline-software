...
public class ClusterList extends Vector<Cluster> {
	...
	private int checkArrays(byte[] sector, byte[] layer, float[] energy, float time[], float[] x, float[] y,
			float[] z) {

		if ((sector == null) || (x == null) || (y == null) || (y == null)) {

			_error = "Unexpected null array when creating HitList: " + "sector = null: " + (sector == null)
					+ "layer = null: " + (layer == null) + "time = null: " + (time == null) + "energy = null: "
					+ (energy == null) + " x == null: " + (x == null) + " y == null: " + (y == null) + " z == null: "
					+ (z == null);
