...
public abstract class ClasIoTrajectoryInfoView extends BaseView implements IClasIoEventListener {
	...
	protected ClasIoTrajectoryInfoView(String title) {
		super(PropertySupport.TITLE, title, PropertySupport.ICONIFIABLE, true, PropertySupport.MAXIMIZABLE, true,
				PropertySupport.CLOSABLE, true, PropertySupport.RESIZABLE, true, PropertySupport.WIDTH, 1050,
				PropertySupport.HEIGHT, 350, PropertySupport.LEFT, 700, PropertySupport.TOP, 100,
