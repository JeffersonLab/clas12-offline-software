...
public class CrossList2 extends Vector<Cross2> {
	...
	public CrossList2(String bankName) {
		...
		length = checkArrays(sector, region, id, x, y, z, ux, uy, uz, err_x, err_y, err_z);
		if (length < 0) {
...
//				float err_x, float err_y, float err_z, float err_ux, float err_uy, float err_uz) {
	...
	private int checkArrays(byte[] sector, byte[] region, short[] id, float[] x, float[] y, float[] z, float[] ux,
			float[] uy, float[] uz, float[] err_x, float[] err_y, float[] err_z) {

		if ((sector == null) || (region == null) || (id == null) || (x == null) || (y == null) || (y == null)
				|| (ux == null) || (uy == null) || (uy == null) || (err_x == null) || (err_y == null)
				|| (err_y == null)) {
