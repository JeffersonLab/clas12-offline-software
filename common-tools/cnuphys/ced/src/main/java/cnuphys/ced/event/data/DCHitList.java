...
public class DCHitList extends Vector<DCHit> {
	...
	private int checkArrays(byte[] sector, byte[] superlayer, byte[] layer, short[] wire, short id[], short status[],
			byte lr[], float[] doca) {

		if ((sector == null) || (superlayer == null) || (layer == null) || (wire == null)) {

			_error = "Unexpected null array when creating HitList: " + "sector = null: " + (sector == null)
					+ "superlayer = null: " + (superlayer == null) + "layer = null: " + (layer == null)
					+ "wire = null: " + (wire == null) + "id = null: " + (id == null) + " status == null: "
					+ (status == null) + " lr == null: " + (lr == null) + " doca == null: " + (doca == null);
