...
public class DCGeometry2 {
	...
	public static void printWire(int superlayer, int layer, int wire) {
		System.out.println(String.format(
				...
				_wireLeftX[superlayer][layer][wire], _wireLeftY[superlayer][layer][wire],
				_wireLeftZ[superlayer][layer][wire], _wireRightX[superlayer][layer][wire],
				_wireRightY[superlayer][layer][wire], _wireRightZ[superlayer][layer][wire],
				_wireMidX[superlayer][layer][wire], _wireMidY[superlayer][layer][wire],
				_wireMidZ[superlayer][layer][wire]));
	}
