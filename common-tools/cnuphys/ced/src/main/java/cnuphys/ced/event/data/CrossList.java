...
public class CrossList extends Vector<Cross> {
	...
	public CrossList(String bankName) {
		...
		length = checkArrays(sector, region, id, x, y, z, ux, uy, uz, err_x, err_y, err_z, err_ux, err_uy, err_uz);
		if (length < 0) {
...
//				float err_x, float err_y, float err_z, float err_ux, float err_uy, float err_uz) {
	...
	private int checkArrays(byte[] sector, byte[] region, short[] id, float[] x, float[] y, float[] z, float[] ux,
			float[] uy, float[] uz, float[] err_x, float[] err_y, float[] err_z, float[] err_ux, float[] err_uy,
			float[] err_uz) {

		if ((sector == null) || (region == null) || (id == null) || (x == null) || (y == null) || (y == null)
				|| (ux == null) || (uy == null) || (uy == null) || (err_x == null) || (err_y == null) || (err_y == null)
				|| (err_ux == null) || (err_uy == null) || (err_uy == null)) {

			_error = "Unexpected null array when creating CrossList: " + "sector = null: " + (sector == null)
					+ " region == null: " + (region == null) + " id == null: " + (id == null) + " x == null: "
					+ (x == null) + " y == null: " + (y == null) + " z == null: " + (z == null) + " ux == null: "
					+ (ux == null) + " uy == null: " + (uy == null) + " uz == null: " + (uz == null)
					+ " err_x == null: " + (err_x == null) + " err_y == null: " + (err_y == null) + " err_z == null: "
					+ (err_z == null) + " err_ux == null: " + (err_ux == null) + " err_uy == null: " + (err_uy == null)
					+ " err_uz == null: " + (err_uz == null);
	...
	private boolean lengthMismatch(byte[] sector, byte[] array, String name) {
		...
		if (sector.length != array.length) {
			_error = "Sector length: " + sector.length + " does not match " + name + " length: " + array.length
					+ " when creating CrossList";
			return true;
		}
		return false;
	}
