...
public class GeometryReportPane extends TextPaneScrollPane {
	...
	static {
		...
		styles.put(MCOLOR.M_BLUE, createStyle(Color.blue, "sansserif", FONTSIZE + 4, false, true));
		styles.put(MCOLOR.M_ORANGERED,
				createStyle(X11Colors.getX11Color("orange red"), "sansserif", FONTSIZE + 3, true, true));
		styles.put(MCOLOR.M_GREEN,
				createStyle(X11Colors.getX11Color("dark Green"), "serif", FONTSIZE + 2, true, false));
		styles.put(MCOLOR.M_RED, createStyle(Color.red, "monospaced", FONTSIZE, false, false));
		styles.put(MCOLOR.M_CORAL, createStyle(X11Colors.getX11Color("coral"), "serif", FONTSIZE + 1, false, true));
	}
