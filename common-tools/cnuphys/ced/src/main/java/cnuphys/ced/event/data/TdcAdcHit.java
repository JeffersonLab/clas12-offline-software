...
public class TdcAdcHit implements Comparable<TdcAdcHit> {
	...
	public String toString() {
		return "sector = " + sector + " layer " + layer + " component: " + component + " " + tdcString() + " "
	 ...
	 * @param feedbackStrings
	 */
	public void tdcAdcFeedback(String componentName, List<String> feedbackStrings) {

		feedbackStrings.add(_fbColor + componentName + " " + component);
