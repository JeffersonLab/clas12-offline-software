...
public class TbHbHitList extends Vector<TbHbHit> {
	...
	private int checkArrays(byte[] sector, byte[] superlayer, byte[] layer6, short[] wire, short[] id, short[] status,
			float[] doca, float[] trkDoca) {

		// docak might be null so exclude
		if ((sector == null) || (superlayer == null) || (layer6 == null) || (wire == null) || (id == null)
				|| (status == null) || (trkDoca == null)) {
