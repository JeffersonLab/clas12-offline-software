...
public class ToolBarToggleButton extends JToggleButton {
     ...
     */
    public ToolBarToggleButton(String imageFileName, String toolTip,
	    String actionCommand, int xh, int yh, String cursorImageFile) {
	this(imageFileName, toolTip, actionCommand, xh, yh, cursorImageFile,
		ICONSIZE, ICONSIZE);
    }
	...
	if (!triedOnce) {
		...
		Image image = ImageManager.getInstance().loadImage(
			customCursorImageFile, this);
		if (image != null) {
