...
public class Test_sort2 {
  ...
  public void test() {
    ...
    if (localflag) {
      fail("*** sort2: First array is not correctly ordered");
    ...
    globalflag = globalflag || localflag;
    if (localflag) {
      fail("*** sort2: Second array did not get correspondingly rearranged");
    ...
    globalflag = globalflag || localflag;
    if (localflag) {
      fail("*** sort2: Sorting second array should have returned first to original order");
