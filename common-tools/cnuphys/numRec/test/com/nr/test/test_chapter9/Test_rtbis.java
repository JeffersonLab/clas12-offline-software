...
import static com.nr.root.Roots.rtbis;
...
public class Test_rtbis {
  ...
  public void test() {
    ...
    System.out.printf("rtbis: Maximum discrepancy = %f\n", maxel(vecsub(root,yy)));
    localflag = maxel(vecsub(root,yy)) > xacc;
    globalflag = globalflag || localflag;
    if (localflag) {
      fail("*** rtbis: Incorrect roots");
  ...
  class Func_rtbis implements UniVarRealValueFun {
    Bessjy b = new Bessjy();
