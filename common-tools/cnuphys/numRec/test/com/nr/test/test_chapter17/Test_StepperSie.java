...
import com.nr.ode.StepperSie;
public class Test_StepperSie {
...
//      System.out.printf(setprecision(12) << yout[i]);
    ...
    if (localflag) {
      fail("*** StepperSie: Inaccurate relationship #1 among yout[i] components");
    ...
    globalflag = globalflag || localflag;
    if (localflag) {
      fail("*** StepperSie: Inaccurate relationship #2 among y[i] components");
  ...
  class rhs_StepperSie implements DerivativeInf{
