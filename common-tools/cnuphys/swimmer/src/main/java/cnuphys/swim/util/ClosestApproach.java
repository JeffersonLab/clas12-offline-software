...
public class ClosestApproach {
	...
	//does a linear interpolation at time t returning the interpolates xyz val in result[3]
	 ...
	 * 
	 * @param results upon return, results[0] is the time of closest approach (ns) and
	 * results[1] is the distance of closest approach (m)
	 */
	...
	public static void closestApproach(SwimTrajectory traj1, SwimTrajectory traj2, 
		...
		results[0] = min.getPoint();
		results[1] = min.getValue();
//		
//		double range10 = (tMax-tMin)/10;
//		
//		if ((md > 0.01) && (mt > (tMin + range10)) && (mt < (tMax - range10))) {
//
//			int n = 20;
