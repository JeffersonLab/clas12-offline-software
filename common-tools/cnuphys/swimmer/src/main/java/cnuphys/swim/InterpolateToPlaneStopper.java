...
public class InterpolateToPlaneStopper implements IStopper {
	 ...
	 */
	public InterpolateToPlaneStopper(double[] u0, double s0, double sMax, Plane targetPlane, double accuracy) {
	...
	public boolean stopIntegration(double s, double[] unew) {
		...
		//a positive distance means we are on the norm side of the plane
