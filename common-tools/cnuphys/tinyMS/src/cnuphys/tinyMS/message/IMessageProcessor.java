...
public interface IMessageProcessor {
	...
	/**
	 * Process a LOGOUT message. This is a message that a client sends signaling a
	 * "logout."
	 * 
	...
	/**
	 * Process a SHUTDOWN message. This is a message that server sends signaling a
	 * "shutdown."
	 * 
	...
	/**
	 * Can be used to toss away messages for example they have the wrong destination
	 * or a client is not verified.
	 * 
	 * @param message the message to process.
