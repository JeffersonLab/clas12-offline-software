...
public interface IMessenger {
	 ...
	 * read from this stream and placed on an inbound queue.
	 * @return the data input stream
	 */
	public DataInputStream getDataInputStream();
	
	/**
	 * Get the data output stream. Messages will be pulled from
	...
	/**
	 * Get the queue where we grab inbound messages. One or more
	 * ReaderThreads will be putting messages in this queue. They
	 * need to be dequeued and processed,
