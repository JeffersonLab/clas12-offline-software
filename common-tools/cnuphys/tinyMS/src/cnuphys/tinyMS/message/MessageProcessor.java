...
/**
 * This object is used by clients and servers to direct messages to their
 * proper handler based on message type. The allowed types are enumerated
 * in {@link MessageType}.
 * @author heddle
 *
 */
...
//		CLOSE, DATA, HANDSHAKE, PING, USER;
	...
	/**
	 * Process a LOGOUT message. This is a message that a client sends
	 * signaling a "logout."
	 * @param message the LOGOUT message to process
	 */
	public abstract void processLogoutMessage(Message message);

	/**
	 * Process a SHUTDOWN message. This is a message that server sends
	 * signaling a "shutdown."
	 * @param message the SHUTDOWN message to process
	 */
	...
	/**
	 * Can be used to toss away messages for example they have the 
	 * wrong destination or a client is not verified.
	 * @param message the message to process.
