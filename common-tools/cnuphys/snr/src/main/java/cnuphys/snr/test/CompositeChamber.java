...
public class CompositeChamber extends ChamberTest {
	 ...
	 */
	public CompositeChamber(DetectorTest detectorTest, String name, NoiseReductionParameters parameters,
	 ...
	 * the coresponding real chamber
	 * 
	 * @param layer         the composite 0-based layer. E.g., if this is 3, then it
	 *                      will hold the results fro chamber 3.
	 * @param segments
	 * @param rightSegments
	 */
