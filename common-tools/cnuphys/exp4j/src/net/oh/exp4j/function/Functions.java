...
public class Functions {
    ...
    private static final int INDEX_ATAN2 = 21;
    private static final int INDEX_TODEGREES = 22;
    private static final int INDEX_TORADIANS = 23;
    ...
    static {
        ...
        builtinFunctions[INDEX_ATAN2] = new Function("atan2", 2) {
            @Override
            public double apply(double... args) {
                return Math.atan2(args[0], args[1]);
            }
        };
        builtinFunctions[INDEX_TODEGREES] = new Function("toDegrees", 1) {
            @Override
            public double apply(double... args) {
                return Math.toDegrees(args[0]);
            }
        };
        builtinFunctions[INDEX_TORADIANS] = new Function("toRadians", 1) {
            @Override
            public double apply(double... args) {
