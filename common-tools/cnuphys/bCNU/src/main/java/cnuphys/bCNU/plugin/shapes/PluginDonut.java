...
public class PluginDonut extends PluginShape {
	 ...
	 */
	public PluginDonut(Plugin plugin, String info, double xc, double yc, double radiusInner, double radiusOuter,
		...
		_item = new DonutItem(plugin.getView().getShapeLayer(), center, radiusInner, radiusOuter, startAngle,
				openingAngle);
