...
public class PluginLine extends PluginShape {
	 ...
	 * @param x1
	 *            the horizontal world coordinate (not pixels) of one end point
	 * @param y1
	 *            the vertical world coordinate (not pixels) of one end point
	 * @param x2
	 *            the horizontal world coordinate (not pixels) of the other end
	 *            point
	 * @param y2
	 *            the vertical world coordinate (not pixels) of the other end
	 *            point
	 * @param properties
	 *            extra custom properties
	 */
	public PluginLine(Plugin plugin, String info, double x1, double y1, double x2, double y2, Object... properties) {
