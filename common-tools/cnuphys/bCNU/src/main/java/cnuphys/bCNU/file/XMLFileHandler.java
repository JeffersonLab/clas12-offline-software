...
public class XMLFileHandler extends AFileHandler {
	...
	/**
	 * An xml file needs to be opened. This could be the result of a drag and drop,
	 * or a open file dialog.
	 * 
	...
	public void handleOpen(Object parent, File file) {
		System.err.println("HandleOpen XML: view: " + parent.getClass().getName());
