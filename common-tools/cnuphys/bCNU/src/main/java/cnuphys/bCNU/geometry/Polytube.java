...
/**
 * A poly tube is a collection of infinite lines that are added in order. Consider a hexagonal tube.
 * That would be the six edges added either CW or CCW as you look down the tube.
 * @author heddle
 *
 */
...
public class Polytube extends ArrayList<Line> {
	...
	/**
	 * Get a polyline for the start or end face. This
	 * treats all the lines as directed segments since the enf (face)
	 * has no meaning for infinite lines.
