...
/**
 * 3D line of the form p(t) = po + t*dp
 * where p(t) is a point on the line, po is one point
 * and dp = (p1-po) where p1 is another point. If this is an
 * infinite line, the t = [-infinity, infinity]. If this is a directed 
 * segment, t = [0, 1]
 * @author heddle
 *
 */
public class Line {
	 ...
	 */
	public Point getP1() {
		return new Point(_po.x + _dp.x,
				_po.y + _dp.y, _po.z + _dp.z);
	}

	
	/**
	 * Get a point on the line
	 * @param t the t parameter. If this is a directed line segment,
	 * t should be restricted to [0, 1]
	 ...
	 * @param p the point
	 * @param maxDistance the max distance it can be off the line
	 * and still considered on the line
	...
	public static void main(String arg[]) {
		...
		p.set(999., 999., 0.001);
		System.out.println(p.toString() + "     distance = " + line.distance(p) + " on line: " + line.pointOnLine(p, 0.01));
