...
public class LassoRectButton extends ToolBarToggleButton implements IRubberbanded {
	 ...
	 */
	public LassoRectButton(final IContainer container, ILassoListener lassoListener, boolean xormode) {
