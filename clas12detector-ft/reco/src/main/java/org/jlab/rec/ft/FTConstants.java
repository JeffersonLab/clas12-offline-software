...
public class FTConstants {
    ...
    public static final double  CAL_HODO_DISTANCE_MATCHING = 30;   // matching distance in mm
    public static final double  CAL_HODO_TIME_MATCHING     = 8;    // matching time in ns
    
    public static final double  CAL_TRK_DISTANCE_MATCHING = 15;   // matching distance in mm
