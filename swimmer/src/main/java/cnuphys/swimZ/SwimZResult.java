...
public class SwimZResult {
	...
	if (sv != null) {
		...
		thetaPhi[1] = Math.toDegrees(Math.atan2(p3[1], p3[0]));
	    }
	}
	return thetaPhi;
    }
	...
	return new GeneratedParticleRecord(_Q, xo, yo, zo, _p, thetaPhi[0],
		thetaPhi[1]);
    }
	...
	SwimTrajectory traj = new SwimTrajectory(_Q, xo, yo, zo, _p,
