...
public class RecoBankWriter {
	...
	public DataBank fillHBCrossesBank(DataEvent event, List<Cross> crosslist) {
		...
		for(int i =0; i< crosslist.size(); i++) {
			...
			bank.setByte("region", i, (byte) crosslist.get(i).get_Region());
			bank.setFloat("x", i, (float) crosslist.get(i).get_Point().x());
			bank.setFloat("y", i, (float) crosslist.get(i).get_Point().y());
			bank.setFloat("z", i, (float) crosslist.get(i).get_Point().z());
			bank.setFloat("err_x", i, (float) crosslist.get(i).get_PointErr().x());
			bank.setFloat("err_y", i, (float) crosslist.get(i).get_PointErr().y());
			bank.setFloat("err_z", i, (float) crosslist.get(i).get_PointErr().z());
			bank.setFloat("ux", i, (float) crosslist.get(i).get_Dir().x());
			bank.setFloat("uy", i, (float) crosslist.get(i).get_Dir().y());
			bank.setFloat("uz", i, (float) crosslist.get(i).get_Dir().z());
			bank.setFloat("err_ux", i, (float) crosslist.get(i).get_DirErr().x());
			bank.setFloat("err_uy", i, (float) crosslist.get(i).get_DirErr().y());
			bank.setFloat("err_uz", i, (float) crosslist.get(i).get_DirErr().z());
			bank.setShort("Segment1_ID", i, (short) crosslist.get(i).get_Segment1().get_Id());
			bank.setShort("Segment2_ID", i, (short) crosslist.get(i).get_Segment2().get_Id());
		}
