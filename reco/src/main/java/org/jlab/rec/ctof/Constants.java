...
public class Constants {
	...
	public static final  int[] NPAD  = new int[1];					// the number of paddles per sector 
	...
	public static final double[] PEDUUNC = new double[1];			// uncertainty in L pedestal
	public static final double[] PEDDUNC = new double[1];			// uncertainty in R pedestal
	public static final double[] ADC_MIP_UNC = new double[1];		// ADC MIP uncertainty
	...
	public static final double MINENERGY = 0.1; 					// 10th of MeV guess --> to be optimized

	public static final int LSBCONVFACERROR = 0;

	public static boolean DEBUGMODE = false;

	public static final double[] TRKMATCHXPAR = new double[1];		// track matching parameter for coord x
...
//	public static final double PCO = 19.4160;						// Constant put the center of the CTOF barrel in its design position
	public static final double PCO = 10.0;							// Constant put the center of the CTOF barrel in its design position according to GEMC
