...
public class Constants {
	...
	public static final  int[] NPAD  = new int[3];					// the number of paddles per sector for panel 1A, 1B, and 2
	...
	public static final double[][]DELTA_T = new double[3][2]; 		// parametrization array for the resolutions of the counters for panels 1,2,3 
	...
	public static final double[] TRKMATCHXPAR = new double[3];		// track matching parameter for coord x
