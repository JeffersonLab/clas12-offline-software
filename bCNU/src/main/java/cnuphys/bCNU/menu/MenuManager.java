...
public class MenuManager {
     ...
     *            the menu label.
     * @param menu
     *            optional menu to add the item to.
     * @param ilist
     *            optional ItemListener.
     */
     ...
     * @param index
     *            the index (0 based) at which to add the item.
     * @param menu
    ...
    public static JMenuItem addMenuItem(String label, char mnemonic,
	    JMenu menu, ActionListener alist) {
