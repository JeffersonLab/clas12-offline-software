...
public class PropertySupport {
    ...
    /**
     * Convert a properties object into an object array.
     * This is the inverse of the fromKeyValues method.
    ...
    /**
     * Get an azimuth angle in degrees. Generally 0 is due north, 
     * 90 due east, etc.
     * @param props the properties
     ...
     * Get the view type.
     * @param props the properties
     * @return the view type. On error, return 
     * Integer.MIN_VALUE (-2^31 = -2147483648).
     */
    public static int getViewType(Properties props) {
	return getInt(props, VIEWTYPE, Integer.MIN_VALUE);
    }
   ...
   /**
    ...
    /**
     * Get the headsup boolean flag, indicating whether the headsup
     ...
     * On error return defaultDataDir.
     */
    ...
    /**
     * Get an optional component used to split the west part
     * of a view
     * @param props  the properties
     ...
     * 
     * @param props the properties
     * @return get the symbol size (width and height) in pixels. 
     * On error return 8.
     */
     ...
     * 
     * @param props the properties
     * @return the rotation angle assumed to be in degrees.
     * On error return 0.
     */
   ...
   public static double getDouble(Properties props, String key) {
    ...
    /**
     * Get a float from properties. Tries to handle both a String (e.g.,
     * "67.0") and Float value.
     * 
     * @param props the properties
     * @param key the key
