...
public class BaseContainer extends JComponent
	...
	/**
	 * The view that holds this container.
	 */
	 ...
	 * 
	 * @param view
	 *            Every container lives on one view. This is the view, which is
	 ...
	 * 
	 * @param name
	 *            the name of the layer. If one with that name already exists,
	 *            it is returned.
	 */
	@Override
	...
	public void worldToLocal(Point pp, Point2D.Double wp) {
		if (worldToLocal != null) {
			try {
				...
				System.err.println("Null pionter exception in BaseContainer worldToLocal pp = " + pp + "  wp = " + wp);
				npe.printStackTrace();
			}
		}
	}
	 ...
	 * 
	 * @param dirty
	 *            If <code>true</code>, offscreen buffer is dirty
	 */
	 ...
	 * 
	 * @param list
	 *            the list it was on, which will be a layer.
	 * @param drawable
	 *            the drawable (item) that changed.
	 * @param type
	 ...
	 * @param p1
	 *            the point at the end of the first leg. Thus pc->p1 determine
	 *            the radius.
	 * @param arcAngle
...
//			System.exit(0);
	 ...
	 * 
	 * @param polygon
	 *            the pixel based polygon
	 * @param worldPolygon
	 *            the world based polygon
	 */
	@Override
