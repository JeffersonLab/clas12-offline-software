...
public class XmlPrintStreamWriter implements XMLStreamWriter {
     ...
     *            the element name
     * @param properties
     *            used to store the attribute name-value pairs
     * @throws XMLStreamException
     */
    public void writeElementWithProps(String elementName, Properties properties)
	    throws XMLStreamException {
    ...
    public void writeArray(String name, double array[])
	    throws XMLStreamException {
	writeArray(name, array, (array == null) ? 0 : array.length);
    }

    public void writeArray(String name, double array[], int dataLen)
	    throws XMLStreamException {
	...
	for (int i = 0; i < dataLen; i++) {
	    writeCharacters("<" + XmlArrayValueElementName + ">" + array[i]
		    + "</" + XmlArrayValueElementName + ">");
    ...
    public void writeArray(String name, long array[], int dataLen)
	    throws XMLStreamException {
	writeStartElement(XmlArrayNumbersElementName);
	writeAttribute(XmlArrayNameAttName, name, " ");
	writeAttribute(XmlArrayTypeAttName, "array", ">");
