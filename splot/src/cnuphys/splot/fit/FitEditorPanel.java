...
public class FitEditorPanel extends JPanel {
    ...
    public static final String BINNUMPROP = "Number of Bins";
    public static final String USERMSPROP = "Use RMS in Legend";
    public static final String STATERRPROP = "Show Stat Errors";

    private static final Font _font = Environment.getInstance().getCommonFont(
	    10);
    private static final Font _font2 = Environment.getInstance().getCommonFont(
	    9);
    ...
    // number of bins
    protected TextFieldSlider _numBinSelector;
    ...
    private void createNumBinSelector() {

	String labels[] = { "4", "100", "200", "300", "400" };
	_numBinSelector = new TextFieldSlider(4, 400, 100, _font, 100, labels,
		180, 40, "Number of Bins") {
	    ...
	    @Override
	    public void valueChanged() {
		firePropertyChange(BINNUMPROP, -1, _numBinSelector.getValue());
	    }
	...
	_numBinSelector.setEnabled(enabled);
	...
	if (curve.isHistogram()) {
	    HistoData hd = curve.getHistoData();
	    _numBinSelector.setValue(hd.getNumberBins());
     ...
     * Get the num bin
     * 
     * @return the num bin selector
     */
    public TextFieldSlider getNumBinSelector() {
	return _numBinSelector;
    }
