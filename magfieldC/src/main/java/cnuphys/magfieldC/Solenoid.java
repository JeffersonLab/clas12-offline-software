...
public final class Solenoid extends MagneticField {
	...
	public void fieldCylindrical(double phi, double rho, double z, CartesianVector result) {
		...
		interpolateField(rho, z, cv); // if the field is cylindrically
		// symmetric, then there is no need
		// for interpolation in phi

		cv.toCartesian(result);
	 ...
	 */
	protected void interpolateField(double q2, double q3, CylindricalVector result) {
		...
		double bphi = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1 * f2;
		...
		double brho = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1 * f2;
		...
		double bz = b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1 * f2;
	...
	protected float interpolateFieldMagnitude(double q2, double q3) {
		...
		return (float) (b000 * g1 * g2 + b001 * g1 * f2 + b010 * f1 * g2 + b011 * f1 * f2);
