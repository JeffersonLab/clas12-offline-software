...
public class TestSupport {
     ...
     * 
     * @param localSystem
     *            a rectangle defining the local (screen-pixel) coordinate
     *            system.
     * @param pp
     ...
     */
    public static void toWorld(Rectangle2D.Double wr, Rectangle localSystem,
	    Point pp, Point2D.Double wp) {
	if ((localSystem != null) && (localSystem.height > 0)
		&& (localSystem.width > 0)) {
	    double xx = wr.x + pp.getX() * wr.width / localSystem.getWidth();
	    double yy = wr.y + (localSystem.height - pp.getY()) * wr.height
		    / localSystem.getHeight();
     ...
     */
    public static void toLocal(Rectangle2D.Double wr, Rectangle localSystem,
	    Point pp, Point2D.Double wp) {
     ...
     */
    public static void toLocal(Rectangle2D.Double world, Rectangle localSystem,
	    Rectangle r, Rectangle.Double wr) {
     ...
     */
    public static void toWorld(Rectangle2D.Double world, Rectangle localSystem,
	    Rectangle r, Rectangle.Double wr) {
     ...
     */
    public static void toLocal(Rectangle2D.Double wr, Rectangle localSystem,
	    Point pp, double wx, double wy) {
	if ((localSystem != null) && (localSystem.height > 0)
		&& (localSystem.width > 0)) {
	    double xx = (wx - wr.x) * localSystem.getWidth() / wr.width;
	    double yy = localSystem.height - (wy - wr.y)
		    * localSystem.getHeight() / wr.height;
