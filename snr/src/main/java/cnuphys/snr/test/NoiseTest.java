...
public class NoiseTest extends JFrame {
    ...
    private NoiseReductionParameters parameters = NoiseReductionParameters
	...
	for (int i = 1; i <= 6; i++) {
	    ...
	    detectorTest.addChamber(new Rectangle2D.Double(xmin, y, width,
		    height));
	}
	...
	return comp != null ? (Frame) SwingUtilities.getAncestorOfClass(
		Frame.class, comp) : null;
    }
