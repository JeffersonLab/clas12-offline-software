...
import cnuphys.ced.cedview.ft.FTCalXYPolygon;
...
//    private final float zmin = 0f;
    ...
    public FTCalPanel3D(float angleX, float angleY, float angleZ,
	...
	//coordinate axes
	Axes3D axes = new Axes3D(this, -xymax, xymax, -xymax, xymax, zmin, zmax, FTCALGeometry.FTCAL_Z0, Color.darkGray, 1f, 6, 6, 6, 
