...
public class CedPluginManager extends PluginManager {
	...
	protected void searchJar(File file, Vector<PHolder> v) {
		...
		// System.err.println("CED PLUGIN MANAGER found jar: " +
	...
	class PView extends BaseView {
		public PView(IDetectorModule evm) {
			super(PropertySupport.TITLE, evm.getName(),
					PropertySupport.ICONIFIABLE, true,
					PropertySupport.MAXIMIZABLE, true, PropertySupport.CLOSABLE,
					true, PropertySupport.RESIZABLE, true,
					PropertySupport.WIDTH, 600, PropertySupport.HEIGHT, 600,
