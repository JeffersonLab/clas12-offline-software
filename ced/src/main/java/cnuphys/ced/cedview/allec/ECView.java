...
public class ECView extends HexView {
     ...
     */
    public void labXYZToLocal(double labXYZ[], Point pp) {
	Point2D.Double wp = new Point2D.Double(labXYZ[0], labXYZ[1]);
     ...
     */
    public void ijkToLocal(int sector, Point3D pijk, Point pp) {
